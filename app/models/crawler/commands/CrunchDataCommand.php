...
class CrunchDataCommand extends Command
{
    /**
    ...
    public function fire()
    {
        ...
        $config['url'] = $this->getArrayfromBLM($config['url']);
		...
		$scrape = $this->scrapeFactory->getScrape('data', $config);
...
//        print_r($output);
    ...
    private function getArrayfromBLM($blmname) {
